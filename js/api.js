...
(function () {
  ...
  window.ALLY_API = {
    ...
    config: function () { return request('GET', '/cabinet/config'); },
    saveConfig: function (config, updatedAt) {
      return request('POST', '/cabinet/config', { config: config, updatedAt: updatedAt });
    },
