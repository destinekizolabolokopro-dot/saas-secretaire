  ...
  function defaults() {
    ...
    return {
      ...
      survey: {
        ...
        /* « Sous 24 h » et non « 24h » : c'est le libellé exact de l'option, et
           les pastilles se comparent à leur libellé. Avec l'ancienne valeur,
           aucune pastille ne s'allumait — le professionnel voyait une question
           sans réponse pendant que le récapitulatif annonçait « 24h », un délai
           qu'il n'avait jamais choisi. */
        motifs: [], rdvDuration: '45', callback: 'Sous 24 h', firstTime: '', notes: '',
